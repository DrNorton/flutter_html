...
class HtmlParser extends StatelessWidget {
  ...
  HtmlParser({
    ...
    required this.disableInlineStyle,
  ...
  Widget build(BuildContext context) {
    ...
    if (!disableInlineStyle) {
      inlineStyledTree = _applyInlineStyles(
          externalCssStyledTree ?? lexedTree, onCssParseError);
    }
    StyledElement customStyledTree =
        _applyCustomStyles(style, inlineStyledTree ?? lexedTree);
